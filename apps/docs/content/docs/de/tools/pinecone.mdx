...
| `includeValues` | boolean | Nein | Vektorwerte in der Antwort einschließen \(Standard: true\) |
| `includeMetadata` | boolean | Nein | Metadaten in der Antwort einschließen \(Standard: true\) |
| `apiKey` | string | Ja | Pinecone API-Schlüssel |
